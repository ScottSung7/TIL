...
class TestRunner {
	...
	public void test1(){
		...
		HTTPResponse response = request.POST("http://133.186.216.200:8081/helps/check-ins", params)
	...
	public void test2(){
		...
		HTTPResponse response = request.PUT("http://133.186.216.200:8081/helps/check-ins/" + checkInId, params)
		assertThat(response.statusCode, is(200))
	...
	public void test3(){
		...
		HTTPResponse response = request.POST("http://133.186.216.200:8081/helps/progress", params)
		assertThat(response.statusCode, is(200))
...
class TestRunner {
	...
	public static void beforeProcess() {
		HTTPRequestControl.setConnectionTimeout(300000)
		test = new GTest(1, "133.186.216.200")
		request = new HTTPRequest()
		grinder.logger.info("before process.")
	}
	...
	@Test
	public void test() {
		HTTPResponse response = request.GET("http://133.186.216.200:8081/helps/check-ins/1", params)
